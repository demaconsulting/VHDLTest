...
**CompileProcessor_WarningOutput_ReturnsWarningResult**: Verifies that a ModelSim warning
line is classified as `RunLineType.Warning`.
This scenario is tested by the compile warning test in `ModelSimSimulatorTests.cs`.
