...
`ModelSimSimulator_Compile_WithFileNameContainingSpaceAndMetacharacter_QuotesFileNameInScript`
in `ModelSimSimulatorTests.cs`.
...
This scenario is tested by
`ModelSimSimulator_Test_WithTestNameContainingSpaceAndMetacharacter_QuotesTestNameInScript`
in `ModelSimSimulatorTests.cs`.
