...
1. **Identify Differences**: Compare VHDLTest repository structure with the TemplateDotNetTool template
...
This agent is typically invoked on VHDLTest to review consistency with TemplateDotNetTool:

1. Access the VHDLTest repository
...
- **Template Evolution**: As TemplateDotNetTool evolves, this agent helps VHDLTest stay current
- **Respect Customization**: Not all differences are problems - some are valid customizations
- **Incremental Adoption**: VHDLTest can adopt template changes incrementally
